...
aircraftOptions.onblur=function() {
...
dropOffLocationInput.onblur=function() {
		// drop off location
...
dropOffDateInput.onblur=function() {
	// drop off date
...
dropOffTimeInput.onblur=function() {
	// drop off time
...
pickUpLocationInput.onblur=function() {
	// pick up location
...
pickUpDateInput.onblur=function() {
	// pick up date
...
pickUpTimeInput.onblur=function() {
	// pick up time
